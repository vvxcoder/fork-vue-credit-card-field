<template>
  <div id="app" class="container">
    ...
    <p>
      This component is meant to be a standalone Vue component that mimics the
      UX of the Stripe.js credit card field without using an iframe AND is
      compatible with Boostrap v4. This component is no way meant to replace
      Stripe.js if you are already using it.
    </p>
    ...
    <p>
      The field works like most input fields and will update the model
      reactively. The card is represent as an object with various properties
    ...
    <p>
      ...
      information gathered to the server that will inevitable result in an error
      of some kind. Errors can be passed in two ways: string or object.
    </p>

    <h4>String</h4>

    <inline-credit-card-field
      error="Pass an error back from the server..."
    ></inline-credit-card-field>
    ...
    <inline-credit-card-field
      name="credit_card"
      :errors="{ credit_card: ['This is error #1', 'This is error #2'] }"
    ></inline-credit-card-field>
    ...
    <p>
      Use the event callbacks to generate a card token, add additional error
      handling, or to send the card data for processing.
    </p>
